...
const Card3 = () => {
  return (
    <div>
      <div>
        <h1 className="text-lg text-blue-950 mb-6">My Cards</h1>
      </div>
      <div className="border-black rounded-3xl h-60 bg-blue-700 min-w-[260px] flex-none">
        <div className="p-5 flex justify-between gap-28">
        ...
        <div className="p-6 flex justify-between gap-28 bg-slate-400 bg-opacity-50 rounded-b-3xl">
          <div>
